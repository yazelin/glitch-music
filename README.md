...
| 網路電台 | 內建四台 24/7 電台（SomaFM Groove Salad／Secret Agent、Radio Paradise、LISTEN.moe，皆為官方公開直連）；「＋ 網路音樂」可貼任何直連音檔或電台串流 URL（加入時標明是否為電台）。電台顯示 LIVE、進度與快轉停用；跨站音訊走第二顆 audio 元素、不接頻譜 graph（沒 CORS 的來源才不會被靜音），頻譜以模擬動畫呈現 |
